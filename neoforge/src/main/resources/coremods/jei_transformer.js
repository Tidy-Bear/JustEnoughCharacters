    ...
    return {
        ...
        'jei-Parser-2': {
            'target': {
                ...
                'class': 'mezz.jei.gui.search.ElementPrefixParser',
                'methodName': "<init>",
                'methodDesc': '(Lmezz/jei/api/runtime/IIngredientManager;Lmezz/jei/common/config/IIngredientFilterConfig;Lmezz/jei/api/helpers/IColorHelper;Lmezz/jei/api/helpers/IModIdHelper;)V'
            },
            'transformer': transform
        },
        'jei-filter': {
            'target': {
                ...
                'methodDesc': '(Ljava/lang/String;)Lmezz/jei/gui/ingredients/IngredientFilter$SearchTokens;'
            },
